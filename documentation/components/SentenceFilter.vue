<template>
    <div class="mb-6">
        <div class="flex flex-wrap gap-4 items-center">
            ...
            <div class="flex items-center gap-2">
                ...
                <select id="category-filter" :value="selectedCategory" @change="handleCategoryChange"
                    class="px-3 py-2 text-base bg-white border-2 border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
        ...
        <div v-if="searchQuery || selectedCategory" class="mt-3 flex items-center gap-2 text-sm text-gray-600">
