<template>
    <div class="flex h-screen bg-gray-100">
        <!-- Sidebar -->
        <div class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out mt-16"
            ...
            <div class="flex-1 overflow-y-auto">
                <nav class="px-4 py-6">
                    ...
                    <div class="mb-6">
                        <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Getting Started
                        </h3>
                        <ul class="space-y-1">
                            <li>
                    ...
                    <div class="mb-6">
                        <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Documentation</h3>
                        <ul class="space-y-1">
                            <li>
        ...
        <div v-if="isOpen" @click="toggleSidebar"
            class="fixed inset-0 z-40 bg-black bg-opacity-50 lg:hidden transition-opacity duration-300 mt-16"></div>

        <!-- Main content -->
        <div class="flex-1 flex flex-col" :class="{ 'lg:ml-64': isOpen, 'lg:ml-0': !isOpen }">
            <!-- Page content -->
            <main class="flex-1 bg-gray-50 mt-16">
                <slot />
            </main>
        </div>
    </div>
...
const { isOpen, toggleSidebar } = inject<UseSidebar>(useSidebarKey, {
    isOpen: ref(false),
    toggleSidebar: () => {
        throw new Error('toggleSidebar not found');
    },
});
</script>
