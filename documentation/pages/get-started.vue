<template>
  ...
  <section class="mb-12">
    ...
    <ol class="list-decimal list-inside ml-6 space-y-2">
      <li><strong>Check out the <router-link to="/quick-start" class="text-blue-600 hover:underline">Quick Start
            Guide</router-link> for a hands-on tutorial.</strong></li>
      <li><strong>Refer to the <router-link to="/configuration" class="text-blue-600 hover:underline">Configuration
            Guide</router-link> for detailed setup instructions.</strong></li>
      <li><strong>Explore the <router-link to="/sentences" class="text-blue-600 hover:underline">Gherkin Sentences
            Dictionary</router-link> to understand available keywords.</strong></li>
      <li><strong>Visit the <a href="https://testflowkit.dreamsfollowers.me/" target="_blank"
            class="text-blue-600 hover:underline">official documentation</a> for comprehensive guides.</strong></li>
    </ol>
  </section>
</template>
