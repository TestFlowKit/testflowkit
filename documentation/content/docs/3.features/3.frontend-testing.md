...
To use the Playwright driver, you must have Go installed and run the following command:

```bash
go run github.com/playwright-community/playwright-go/cmd/playwright@latest install --with-deps
```

This command installs the Playwright browser binaries and system dependencies required for browser automation.

::alert{type="warning"}
**Go Required:** The Playwright driver requires [Go 1.19+](https://golang.org/dl/) to be installed on your system.
::
