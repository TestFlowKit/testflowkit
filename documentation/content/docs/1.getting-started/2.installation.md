...
- ℹ️ **Optional:** [Go 1.19+](https://golang.org/dl/) if you plan to use the Playwright browser driver
...
If you plan to use the Playwright browser driver (instead of the default Rod driver), you need to install Playwright's browser binaries.

### Prerequisites for Playwright

1. Install [Go 1.19+](https://golang.org/dl/) if not already installed
2. Run the Playwright installation command:

```bash
go run github.com/playwright-community/playwright-go/cmd/playwright@latest install --with-deps
```

This command downloads Chromium and installs system dependencies required by Playwright.

> ℹ️ **Note:** The Rod driver (default) does not require this step. It automatically downloads Chrome when needed.
