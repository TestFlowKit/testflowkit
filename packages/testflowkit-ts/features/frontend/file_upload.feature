...
Feature: File Upload e2e tests
    ...
    Scenario: a user can upload a single file successfully
        ...
        Then the "files uploaded block" should be visible
        And the "files uploaded block" should contain the text "avatar.png"
    ...
    Scenario: a user can upload multiple files successfully
        ...
        Then the "files uploaded block" should be visible
        And the "files uploaded block" should contain the text "image1.jpg"
    ...
    Scenario: a user can upload a document successfully
        ...
        Then the "files uploaded block" should be visible
        And the "files uploaded block" should contain the text "test.pdf"

    @CSV_UPLOAD
    Scenario: a user can upload a CSV file successfully
        When the user uploads the "sample_csv" file into the "Data" field
        Then the "files uploaded block" should be visible
        And the "files uploaded block" should contain the text "sample.csv"
