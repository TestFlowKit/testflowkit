...
| `SecurityScheme` struct (type, token/credentials, scopes, proxy_url, duration, retry_on_401) | ✅ Done | `internal/config/types.go` |
...
### ✅ Phase 4 – Transport, Proxy & Retry-on-401
...
### ✅ Phase 5 – CLI Lifecycle & Boilerplate
...
| 2 | OIDC/PKCE deferred; provider interface reserved with explicit not-implemented error | 2026-03-16 |
| 3 | Certificate provider deferred; same interface stub strategy | 2026-03-16 |
| 4 | BDD auth steps (role switch, force refresh) deferred to next implementation pass | 2026-03-16 |
| 5 | `default_headers` backward compatibility preserved with zero changes to DefaultHeaders behaviour | 2026-03-16 |
| 6 | Safety buffer for token expiry is 30 seconds | 2026-03-16 |
| 7 | retry_on_401 is opt-in per scheme, disabled by default, max 1 re-auth + 1 retry | 2026-03-16 |
...
- [ ] `go test ./internal/security/...` — resolver precedence coverage
