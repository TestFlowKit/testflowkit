...
// ToStateEntry converts a TokenResult into a state.TokenEntry for persistence.
func (r *TokenResult) ToStateEntry(schemeHash string) *state.TokenEntry {
	return &state.TokenEntry{
